...
func (c *Command) init() {
	...
	c.flags.StringVar(&c.flagServerAddr, "server-addr", "",
		"The URL, IP or the Cloud auto-join string pointing to the Consul server. The server must be running with TLS enabled."+
		"The default HTTPS port 8501 will be used for all connections.")
